...
# so /v1/*, /admin/login, and /sub/* all work on airnetwork.flash-myanmar.com.
# nginx: airnetwork.flash-myanmar.com → 127.0.0.1:9090
HTTP_PORT="${MOBILE_API_PORT:-${SUB_SERVER_PORT:-9090}}"
